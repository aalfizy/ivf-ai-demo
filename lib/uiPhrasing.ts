...
export const hopeClosingBody = (role: SpeakerRole) =>
  pick(role, {
    wife: "التقرير قدامك دلوقتي. تقدري تحمّليه أو ترسليه عبر واتساب من الزر اللي في الأسفل. اعتني بنفسك، وإحنا معاكي خطوة بخطوة.",
    husband: "التقرير قدامك دلوقتي. تقدر تحمّله أو ترسله عبر واتساب من الزر اللي في الأسفل. اعتني بنفسك، وإحنا معاك خطوة بخطوة.",
    unknown: "التقرير قدامكم دلوقتي. تقدروا تحمّلوه أو ترسلوه عبر واتساب من الزر اللي في الأسفل. اعتنوا بنفسكم، وإحنا معاكم خطوة بخطوة.",
  });
...
export const referenceIdNoteText = (role: SpeakerRole) =>
  pick(role, {
    wife:
      "تم استخدام رقم مرجعي للتقرير في الأعلى بدل أي اسم أو بيانات شخصية، حفاظاً على خصوصيتك. " +
      "يمكنك تحميل التقرير أو إرساله مباشرة عبر واتساب من الزر الموجود في الأسفل. " +
      "لا يتم الاحتفاظ بأي بيانات أو ملفات بعد انتهاء الجلسة.",
    husband:
      "تم استخدام رقم مرجعي للتقرير في الأعلى بدل أي اسم أو بيانات شخصية، حفاظاً على خصوصيتك. " +
      "يمكنك تحميل التقرير أو إرساله مباشرة عبر واتساب من الزر الموجود في الأسفل. " +
      "لا يتم الاحتفاظ بأي بيانات أو ملفات بعد انتهاء الجلسة.",
    unknown:
      "تم استخدام رقم مرجعي للتقرير في الأعلى بدل أي اسم أو بيانات شخصية، حفاظاً على الخصوصية. " +
      "يمكنكم تحميل التقرير أو إرساله مباشرة عبر واتساب من الزر الموجود في الأسفل. " +
      "لا يتم الاحتفاظ بأي بيانات أو ملفات بعد انتهاء الجلسة.",
  });
