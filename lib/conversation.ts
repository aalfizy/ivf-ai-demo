...
const QUESTIONS: Partial<Record<StepId, Record<SpeakerRole, string[]>>> = {
  ...
  consent: {
    wife: [
      "تحبي تفتحي التقرير دلوقتي عشان تراجعيه أو تحمّليه؟",
    ],
    husband: [
      "تحب تفتح التقرير دلوقتي عشان تراجعه أو تحمّله؟",
    ],
    unknown: [
      "تحبوا نفتح التقرير دلوقتي عشان تراجعوه أو تحمّلوه؟",
    ],
  },
};
...
function buildSummarySpeech(answers: Answers): string {
  ...
  // Local-first closing: NEVER promises that anyone will follow up and
  // NEVER claims data was stored. Just nudges the user towards reviewing
  // the report they already have on screen.
  const closing = roleAware(role, {
    feminine: "تحبي نفتح التقرير دلوقتي... عشان تراجعيه وتحمّليه؟",
    masculine: "تحب نفتح التقرير دلوقتي... عشان تراجعه وتحمّله؟",
    neutral: "تحبوا نفتح التقرير دلوقتي... عشان تراجعوه وتحمّلوه؟",
  });

  if (!r.dataSufficient) {
    return (
      "البيانات اللي معانا دلوقتي مش كافية لتقييم تفصيلي... " +
      "بس فيه خطوات عملية واضحة هتساعد في توضيح المسار العلاجي. " +
  ...
  const lead =
    r.confidence === "medium"
      ? "بناءً على كلامكم والوثائق اللي رفعتوها"
      : "بناءً على كلامكم والمعلومات اللي وصلتنا";

  return (
    `${lead}... تشير البيانات الأولية إلى مؤشرات يمكن البناء عليها... ` +
    `هتساعد توجّه الخطوات القادمة مع الطبيب المختص. ` +
...
export function handleAnswer(
  ...
  switch (step) {
    ...
    case "consent": {
      ...
      //   - We NEVER claim the data was saved or stored.
      //   - We NEVER promise a follow-up call from "the clinic".
      //   - We tell the user the report is generated locally for them
      //     and that they may download it or send it via WhatsApp using
      //     the button shown on the final report.
      //   - We reassure them no data or files are retained after the
      //     session ends.
      if (c === "yes") {
        const closing = roleAware(role, {
          feminine:
            "تمام... هفتحلك التقرير دلوقتي. " +
            "تقدري تحمّليه أو ترسليه عبر واتساب من الزر اللي هتلاقيه في التقرير. " +
            "حفاظاً على خصوصيتك... ما بنحتفظش بأي بيانات أو ملفات بعد انتهاء الجلسة.",
          masculine:
            "تمام... هفتحلك التقرير دلوقتي. " +
            "تقدر تحمّله أو ترسله عبر واتساب من الزر اللي هتلاقيه في التقرير. " +
            "حفاظاً على خصوصيتك... ما بنحتفظش بأي بيانات أو ملفات بعد انتهاء الجلسة.",
          neutral:
            "تمام... هفتحلكم التقرير دلوقتي. " +
            "تقدروا تحمّلوه أو ترسلوه عبر واتساب من الزر اللي هتلاقوه في التقرير. " +
            "حفاظاً على الخصوصية... ما بنحتفظش بأي بيانات أو ملفات بعد انتهاء الجلسة.",
        });
        return {
          assistant: closing,
          next: "done",
      ...
      if (c === "no") {
        const closing = roleAware(role, {
          feminine:
            "ماشي... مش هنفتح التقرير دلوقتي. " +
            "في أي وقت تقدري تبدأي من الأول وتعملي تقرير جديد. " +
            "حفاظاً على خصوصيتك... ما بنحتفظش بأي بيانات أو ملفات بعد انتهاء الجلسة.",
          masculine:
            "ماشي... مش هنفتح التقرير دلوقتي. " +
            "في أي وقت تقدر تبدأ من الأول وتعمل تقرير جديد. " +
            "حفاظاً على خصوصيتك... ما بنحتفظش بأي بيانات أو ملفات بعد انتهاء الجلسة.",
          neutral:
            "ماشي... مش هنفتح التقرير دلوقتي. " +
            "في أي وقت تقدروا تبدأوا من الأول وتعملوا تقرير جديد. " +
            "حفاظاً على الخصوصية... ما بنحتفظش بأي بيانات أو ملفات بعد انتهاء الجلسة.",
        });
        return {
          assistant: closing,
